    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/api/exam/list").hasAnyRole("ADMIN")
                        .requestMatchers("/api/exam/getCreatedByUser").hasAnyRole("ADMIN", "TEACHER")
                        .requestMatchers("/api/exam/getForUser").authenticated()
                        ...
                        .requestMatchers("/api/bill/delete/**","api/bill/findBillByAttribute", "/api/bill/findBillBetweenDates").hasAnyRole("ADMIN")
